...
public class PullToZoomListViewEx extends PullToZoomBase<ListView> implements AbsListView.OnScrollListener {
    ...
    private OnScrollListener mScrollListener;  //滚动的监听
    ...
    public interface OnScrollListener {
        ...
        // 监听头部滚动，范围从 0 ~ maxY
        void onHeaderScroll(int currentY, int maxY);
    }
    ...
    public void setZoomViewAndHeaderView(View zoomView, View headerView) {
        if (zoomView != null && headerView != null) {
            this.mZoomView = zoomView;
            this.mHeaderView = headerView;
            updateHeaderView();
        }
    ...
    public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
        if (!isHideHeader() && isPullToZoomEnabled()) {
            ...
            if (mScrollListener != null) {
                mScrollListener.onHeaderScroll(f, mHeaderHeight);
            }
        }
    ...
    class ScalingRunnable implements Runnable {
        ...
        public void run() {
            ...
            if ((!mIsFinished) && (mScale > 1.0D)) {
                ...
                if (localLayoutParams == null) return;
        ...
        public void startAnimation(long paramLong) {
            ...
            int currentHeaderHeight = mHeaderContainer.getBottom();
            ViewGroup.LayoutParams localLayoutParams = mHeaderContainer.getLayoutParams();
            if (localLayoutParams != null && localLayoutParams.height > 0) {
                currentHeaderHeight = localLayoutParams.height;
            }
            mScale = ((float) currentHeaderHeight / mHeaderHeight);
            mIsFinished = false;
            post(this);
        }
    }
